<?php
    ...
    $admin = query("SELECT * FROM quiz_pemijahan");

    if (isset($_POST["submit"])) {
        
        if (quizpemijahan($_POST) > 0 ) {
            echo "<script> 
            ...
            <div class="row">
                ...
                <div class="col" id="kol-dashboard" style="margin-right: -80px;">
                    <div class="row" id="header-dashboard">
                        <div class="col">
                            <span> 
                                <h2><i class="fa-solid fa-newspaper"></i>QUIZ PEMIJAHAN</h2>
                    ...
                    <div class="card mt-5">
                        <h5 class="card-header">Form Tambah soal quiz pemijahan</h5>
                    ...
                    <div class="card mt-5">
                        <h5 class="card-header">soal quiz pemijahan</h5>
                        <div class="card-body shadow">
                            <table class="table">
                                <thead>
                                    <tr>
