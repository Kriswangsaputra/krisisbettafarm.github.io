                        ...
                        <div class="col">
                            <div class="card shadow" id="isi-submenu-profil-admin" style="width:28rem;">
                                <div class="card-header">
                                    <h5 class="card-title"><i class="fa-solid fa-circle-user"></i> Informasi Pribadi</h5>
                                </div>
                                <div class="card-body">
                                    <div class="kotak-isian">
                                        <label for="">Nama</label>
                                        <input type="text" name="" disabled value="<?=$row["nama_adm"];?>" style="display:block; border:none; background:none;">
                                    </div>
                                    <div class="kotak-isian">
                                        <label for="">Tempat Lahir</label>
                                        <input type="text" name="" disabled value="<?=$row["tempat_lhr_adm"];?>" style="display:block; border:none; background:none;">
                                    </div>
                                    <div class="kotak-isian">
                                        <label for="">Tanggal Lahir</label>
                                        <input type="text" name="" disabled value="<?=$row["tgl_lhr_adm"];?>" style="display:block; border:none; background:none;">
                                    </div>
                                    <div class="kotak-isian">
                                    ...
                                    <div class="d-grid gap-2">
                                        <a href="dashboard-admin-form-infopribadi.php" class="btn btn-outline-primary" type="button">Ubah Informasi Pribadi</a>
                                        <a href="dashboard-admin-profil.php" type="button" class="btn btn-outline-success">Kembali</a>
                                    </div>
                                </div>
                            </div>
                        </div>
