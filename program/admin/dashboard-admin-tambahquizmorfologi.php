<?php
    ...
    $admin = query("SELECT * FROM quiz_morfologi");

    if (isset($_POST["submit"])) {
        
        if (quizmorfologi($_POST) > 0 ) {
            echo "<script> 
            ...
            <div class="row">
                ...
                <div class="col" id="kol-dashboard" style="margin-right: -80px;">
                    <div class="row" id="header-dashboard">
                        <div class="col">
                            <span> 
                                <h2><i class="fa-solid fa-newspaper"></i>QUIZ MORFOLOGI</h2>
                    ...
                    <div class="card mt-5">
                        <h5 class="card-header">Form Tambah soal quiz morfologi</h5>
                    ...
                    <div class="card mt-5">
                        <h5 class="card-header">soal quiz morfologi</h5>
                        <div class="card-body shadow">
                            <table class="table">
                                <thead>
                                    <tr>
