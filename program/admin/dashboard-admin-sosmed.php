                            ...
                            <div class="card shadow" id="isi-submenu-profil-admin" style="width:28rem;">
                                ...
                                <div class="card-body">
                                    <div class="kotak-isian">
                                        ...
                                        <input type="text" name="" disabled value="<?=$row["facebook_adm"];?>" style="display:block; border:none; background:none;">
                                    </div>
                                    <div class="kotak-isian">
                                        <label for="">Instagram</label>
                                        <input type="text" name="" disabled value="<?=$row["instagram_adm"];?>" style="display:block; border:none; background:none;">
                                    </div>
                                    <div class="kotak-isian">
                                        <label for="">Twitter</label>
                                        <input type="text" name="" disabled value="<?=$row["twitter_adm"];?>" style="display:block; border:none; background:none;">
                                    </div>
                                    <div class="d-grid gap-2">
                                        <a href="dashboard-admin-form-sosmed.php" class="btn btn-outline-primary" type="button">Ubah Sosial Media</a>
