<?php
    ...
    $admin = query("SELECT * FROM tentang_kami");

    if (isset($_POST["submit"])) {
        
        if (tambahtentangkami($_POST) > 0 ) {
            echo "<script> alert('Konten Baru Berhasil Ditambahkan!')</script>";
        }else {
        ...
        <div class="container-sm">
            <div class="row">
                ...
                <div class="col" id="kol-dashboard">
                    ...
                    <a class="btn btn-primary me-5" href="dashboard-admin-konten-tentangkami.php" role="button">Kembali</a>

                    <div class="card mt-5">
                        <h5 class="card-header">Form Tambah Konten Tentang Kami</h5>
                        <div class="card-body shadow">
                            <form action="" method="post">
                                ...
                                <div class="kotak-isian">
                                    <input type="textarea" name="visi" class="form-info">
                                    <label for="" class="label-form-info">Visi</label>
                                </div>
                                <div class="kotak-isian">
                                    <input type="textarea" name="misi" class="form-info">
                                    <label for="" class="label-form-info">Misi</label>
                                </div>
