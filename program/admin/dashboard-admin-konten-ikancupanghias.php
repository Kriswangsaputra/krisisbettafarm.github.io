<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        mysqli_query($koneksi, "DELETE FROM ikancupanghias WHERE id = $id");
    }
        ...
        <div class="container-sm">
            <div class="row">
                ...
                <div class="col" id="kol-dashboard">
                    ...
                    <a class="btn btn-primary" href="dashboard-admin-konten-ikancupangalam.php" role="button">Kembali</a>
                    <a class="btn btn-success" href="dashboard-admin-konten-tambah-ikancupanghias.php" role="button">Tambah Konten</a>
                    ...
                    <div class="card mt-5">
                        <h5 class="card-header"> Tabel Ikan Cupang Hias</h5>
                        ...
                        <table class="table mb-5">
                                ...
                                <tbody>
                                    <?php foreach ($admin as $row) : ?>
                                        <tr>
                                            <td><?=$row["id"];?></td>
                                            <td><?=$row["judul_cpnghias"];?></td>
                                            <td><?=$row["subjudul_cpnghias"];?></td>
                                            <td><img src="../../img/upload/<?=$row["gambar_cpnghias"];?>" alt="" width="50"></td>
                                            <td><?=$row["jenis_cpnghias"];?></td>
                                            <td><?=$row["penjelasan_jenis_cpnghias"];?></td>
                                            <td>
