    ...
    if (isset($_POST["submit"])) {
        ...
        if (ubahinfo($_POST) > 0 ) {
            echo "<script>
                ...
                document.location.href='dashboard-admin-infopribadi.php';
            </script>";
        }else {
            echo "
                        ...
                        <div class="col">
                            <div class="card shadow" id="isi-submenu-profil-admin" style="width:28rem;">
                                <div class="card-header">
                                    <h5 class="card-title"><i class="fa-solid fa-circle-user"></i> Ubah Informasi Pribadi</h5>
                                </div>
                                <div class="card-body">
                                    <form action="" method="post">
                                        <input type="hidden" name="id" value="<?=$row["id_adm"];?>">
                                        <div class="kotak-isian">
                                            <input type="text" name="nama" class="form-info" value="<?=$row["nama_adm"];?>">
                                            <label for="" class="label-form-info">Nama</label>
                                        </div>
                                        <div class="kotak-isian">
                                            <input type="text" name="tempat_lahir" class="form-info" value="<?=$row["tempat_lhr_adm"];?>">
                                            <label for="" class="label-form-info">Tempat Lahir</label>
                                        </div>
                                        <div class="kotak-isian">
                                            <input type="date" name="tanggal_lahir" class="form-info" value="<?=$row["tgl_lhr_adm"];?>">
                                            <label for="" class="label-form-info">Tanggal Lahir</label>
                                        </div>
                                        <div class="kotak-isian">
                                            <input type="text" name="nmpengguna" class="form-info" value="<?=$row["nmpengguna_adm"];?>">
                                        ...
                                        <div class="d-grid gap-2">
                                            ...
                                            <a href="dashboard-admin-infopribadi.php" type="button" class="btn btn-outline-success">Kembali</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
