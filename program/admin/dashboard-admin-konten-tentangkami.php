        ...
        <div class="container-sm">
            <div class="row">
                ...
                <div class="col" id="kol-dashboard">
                    ...
                    <a class="btn btn-primary" href="dashboard-admin-konten-tambah-tentangkami.php" role="button">Tambah Konten</a>
                    ...
                    <table class="table mb-5">
                        ...
                        <tbody>
                            <?php foreach ($admin as $row) : ?>
                                <tr>
                                    <td><?=$row["id"];?></td>
                                    <td><?=$row["judul_tentangkami"];?></td>
                                    <td><?=$row["subjudul_tentangkami"];?></td>
                                    <td><?=$row["visi"];?></td>
                                    <td><?=$row["misi"];?></td>
                                    <td>
                                        <a class="btn btn-danger" href="hapus-admin.php?id<?=$row["id"];?>" onclick="return confirm('Yakin Untuk Menghapus Data?!');" role="button">Hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
