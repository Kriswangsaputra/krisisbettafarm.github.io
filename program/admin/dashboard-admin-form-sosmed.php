    ...
    if (isset($_POST["submit"])) {
        ...
        if (ubahsosmed($_POST) > 0 ) {
            echo "<script>
                ...
                document.location.href='dashboard-admin-sosmed.php';
            </script>";
        }else {
            echo "
                        ...
                        <div class="col">
                            <div class="card shadow" id="isi-submenu-profil-admin" style="width:28rem;">
                                <div class="card-header">
                                    <h5 class="card-title"><i class="fa-solid fa-users"></i> Sosial Media</h5>
                                </div>
                                <div class="card-body">
                                    <form action="" method="post">
                                        <input type="hidden" name="id" value="<?=$row["id_adm"];?>">
                                        <div class="kotak-isian">
                                            <input type="text" name="facebook" class="form-info" value="<?=$row["facebook_adm"];?>">
                                            <label for="" class="label-form-info">Facebook</label>
                                        </div>
                                        <div class="kotak-isian">
                                            <input type="text" name="instagram" class="form-info" value="<?=$row["instagram_adm"];?>">
                                            <label for="" class="label-form-info">Instagram</label>
                                        </div>
                                        <div class="kotak-isian">
                                            <input type="text" name="twitter" class="form-info" value="<?=$row["twitter_adm"];?>">
                                            <label for="" class="label-form-info">Twitter</label>
                                        </div>
                                        <div class="d-grid gap-2">
                                            <button class="btn btn-outline-primary" type="submit" name="submit">Ubah Sosial Media</button>
                                            <a href="dashboard-admin-sosmed.php" type="button" class="btn btn-outline-success">Kembali</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
