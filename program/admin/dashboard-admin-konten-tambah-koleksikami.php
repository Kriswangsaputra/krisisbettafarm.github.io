<?php
    ...
    $admin = query("SELECT * FROM koleksi_kami");

    if (isset($_POST["submit"])) {
        
        if (tambahkoleksikami($_POST) > 0 ) {
            echo "<script> 
            alert('Konten Baru Berhasil Ditambahkan!');
            document.location.href = 'dashboard-admin-konten-koleksikami.php';
            </script>";
        }else {
        ...
        <div class="container-sm">
            <div class="row">
                ...
                <div class="col" id="kol-dashboard">
                    ...
                    <a class="btn btn-primary me-5" href="dashboard-admin-konten-koleksikami.php" role="button">Kembali</a>

                    <div class="card mt-5">
                        <h5 class="card-header">Form Tambah Konten Koleksi Kami</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="kotak-isian">
                                                ...
                                                <label for="" class="label-form-info">Gambar</label>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                <div class="kotak-isian">
                                    <input type="textarea" name="deskripsi" class="form-info">
                                    <label for="" class="label-form-info">Deskripsi</label>
                                </div>
