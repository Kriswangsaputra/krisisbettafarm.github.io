                        ...
                        <div class="col">
                            <div class="card shadow" id="isi-submenu-profil-admin" style="width:28rem; height: 21rem;">
                                <div class="card-header">
                                    <h5 class="card-title">Lihat Atau Edit Profile</h5>
                                </div>
                                <div class="card-body">
                                    <h5 class="isi">
                                    <ul>
                                        <li><a href="dashboard-admin-infopribadi.php"><i class="fa-solid fa-circle-user" id="isi-submenu-info"></i> Informasi Pribadi</a></li>
                                        <li><a href="dashboard-admin-kontak.php"><i class="fa-solid fa-id-card" id="isi-submenu-kontak"></i> Kontak Pribadi</a></li>
                                        <li><a href="dashboard-admin-sosmed.php"><i class="fa-solid fa-users" id="isi-submenu-sosmed"></i> Sosial Media</a></li>
                                    </ul>
                                    </h5>
                                </div>
                            </div>
