<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        if (tambahcupangalam($_POST) > 0 ) {
            echo "<script> 
            alert('Konten Baru Berhasil Ditambahkan!');
            document.location.href = 'dashboard-admin-konten-ikancupangalam.php';
            </script>";
        }else {
        ...
        <div class="container-sm">
            <div class="row">
                ...
                <div class="col" id="kol-dashboard">
                    ...
                    <a class="btn btn-primary me-5" href="dashboard-admin-konten-ikancupangalam.php" role="button">Kembali</a>

                    <div class="card mt-5">
                        <h5 class="card-header">Form Tambah Konten Ikan Cupang Alam</h5>
