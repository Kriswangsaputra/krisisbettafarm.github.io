                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card" style="width: 18rem;" id="profil-admin">
                                ...
                                <div class="card-body">
                                    <p class="card-text">Kelola Konten Tentang kami</p>
                                    <a href="dashboard-admin-konten-tentangkami.php" class="btn btn-primary">Kelola</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="card" style="width: 18rem;" id="pelatihan">
                                <div class="card-header">
                                    <h5 class="card-title">Koleksi Kami</h5>
                                </div>
                                <div class="card-body">
                                    <p class="card-text">Kelola Konten Koleksi Kami</p>
                                    <a href="dashboard-admin-konten-koleksikami.php" class="btn btn-primary">Kelola</a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" style="width: 18rem;"id="konten">
                                <div class="card-header">
                                    <h5 class="card-title">Halaman Belajar</h5>
                                </div>
                                <div class="card-body">
                                    <p class="card-text">Kelola Konten halaman Belajar</p>
                                    <a href="dashboard-admin-konten-sejarah.php" class="btn btn-primary">Kelola</a>
                                </div>
                            </div>
                        </div>
                    </div>
