                            ...
                            <div class="card shadow" id="isi-submenu-profil-admin" style="width:28rem;">
                                ...
                                <div class="card-body">
                                    <div class="kotak-isian">
                                        ...
                                        <input type="text" name="" disabled value="<?=$row["alamat_adm"];?>" style="display:block; border:none; background:none;">
                                    </div>
                                    <div class="kotak-isian">
                                        <label for="">Email</label>
                                        <input type="Email" name="" disabled value="<?=$row["email_adm"];?>" style="display:block; border:none; background:none;">
                                    </div>
                                    <div class="kotak-isian">
                                        <label for="">Telepon</label>
                                        <input type="number" name="" disabled value="<?=$row["telepon_adm"];?>" style="display:block; border:none; background:none;">
                                    </div>
                                    <div class="d-grid gap-2">
                                        <a href="dashboard-admin-form-kontak.php" class="btn btn-outline-primary" type="button">Ubah kontak Pribadi</a>
