<?php
    ...
    $admin = query("SELECT * FROM ikancupangalam");

    if (isset($_POST["submit"])) {
        
        $id = $_POST["id"];

        mysqli_query($koneksi, "DELETE FROM ikancupangalam WHERE id = $id");
    }
        ...
        <div class="container-sm">
            <div class="row">
                ...
                <div class="col" id="kol-dashboard">
                    ...
                    <a class="btn btn-primary" href="dashboard-admin-konten-sejarah.php" role="button">Kembali</a>
                    <a class="btn btn-success" href="dashboard-admin-konten-tambah-ikancupangalam.php" role="button">Tambah Konten</a>
                    <a class="btn btn-secondary" href="dashboard-admin-konten-ikancupanghias.php" role="button">Cek Tabel Ikan Cupang Hias</a>
                    <a class="btn btn-info" href="dashboard-admin-konten-sejarah.php" role="button">Cek Tabel sejarah Ikan Cupang</a>

                    <div class="card mt-5">
                        <h5 class="card-header"> Tabel Ikan Cupang Alam</h5>
                        <div class="card-body shadow">
                            <table class="table mb-5">
                                <thead>
                                    ...
                                    <th scope="col">penjelasan jenis</th>
                                ...
                                <tbody>
                                    <?php foreach ($admin as $row) : ?>
                                        <tr>
                                            <td><?=$row["id"];?></td>
                                            <td><?=$row["judul_cpngalam"];?></td>
                                            <td><?=$row["penjelasan_cpngalam"];?></td>
                                            <td><img src="../../img/upload/<?=$row["gambar_cpngalam"];?>" alt="" width="50"></td>
                                            <td><?=$row["jenis_cpngalam"];?></td>
                                            <td><?=$row["deskripsi_jenis_cpngalam"];?></td>
                                            <td>
