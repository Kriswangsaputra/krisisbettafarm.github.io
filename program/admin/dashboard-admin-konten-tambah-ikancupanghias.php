<?php
    ...
    $admin = query("SELECT * FROM ikancupanghias");

    if (isset($_POST["submit"])) {
        
        if (tambahcupanghias($_POST) > 0 ) {
            echo "<script> 
            alert('Konten Baru Berhasil Ditambahkan!');
            document.location.href = 'dashboard-admin-konten-ikancupanghias.php';
            </script>";
        }else {
        ...
        <div class="container-sm">
            <div class="row">
                ...
                <div class="col" id="kol-dashboard">
                    ...
                    <a class="btn btn-primary me-5" href="dashboard-admin-konten-ikancupanghias.php" role="button">Kembali</a>

                    <div class="card mt-5">
                        <h5 class="card-header">Form Tambah Konten Ikan Cupang Hias</h5>
                        <div class="card-body shadow">
                        <form action="" method="post" enctype="multipart/form-data">
                                <div class="kotak-isian">
                                    <input type="text" name="judul" class="form-info">
                                    <label for="" class="label-form-info">Judul</label>
                                </div>
                                <div class="kotak-isian">
                                    <input type="text" name="subjudul" class="form-info">
                                    <label for="" class="label-form-info">Subjudul</label>
                                </div>
                                <div class="kotak-isian">
                                    <input type="file" name="gambar" class="form-info">
                                    <label for="" class="label-form-info">foto</label>
                                </div>
                                <div class="kotak-isian">
                                    <input type="text" name="jenis" class="form-info">
                                    <label for="" class="label-form-info">jenis</label>
                                </div>
                                <div class="kotak-isian">
                                    <input type="textarea" name="penjelasan" class="form-info">
                                    <label for="" class="label-form-info">Penjelasan Jenis</label>
                                </div>
