<?php
    ...
    $admin = query("SELECT * FROM quiz_media_budidaya");

    if (isset($_POST["submit"])) {
        
        if (quizmediabudidaya($_POST) > 0 ) {
            echo "<script> 
    ...
    <body>
        ...
        <div class="container-sm">
            <div class="row">
                ...
                <div class="col" id="kol-dashboard" style="margin-right: -80px;">
                    <div class="row" id="header-dashboard">
                        <div class="col">
                            <span> 
                                <h2><i class="fa-solid fa-newspaper"></i>QUIZ MEDIA BUDIDAYA</h2>
                    ...
                    <div class="card mt-5">
                        <h5 class="card-header">Form Tambah soal quiz media budidaya</h5>
                    ...
                    <div class="card mt-5">
                        <h5 class="card-header">soal quiz media budidaya</h5>
                        <div class="card-body shadow">
                            <table class="table">
                                <thead>
                                    <tr>
