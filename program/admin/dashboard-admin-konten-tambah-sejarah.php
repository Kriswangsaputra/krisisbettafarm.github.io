<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        if (tambahsejarah($_POST) > 0 ) {
            echo "<script> 
            alert('Konten Baru Berhasil Ditambahkan!');
            document.location.href = 'dashboard-admin-konten-sejarah.php';
            </script>";
        }else {
        ...
        <div class="container-sm">
            <div class="row">
                ...
                <div class="col" id="kol-dashboard">
                    ...
                    <a class="btn btn-primary me-5" href="dashboard-admin-konten-sejarah.php" role="button">Kembali</a>

                    <div class="card mt-5">
                        <h5 class="card-header">Form Tambah Konten Sejarah Ikan Cupang</h5>
