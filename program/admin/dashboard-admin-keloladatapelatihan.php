<?php
    ...
    $admin = query("SELECT * FROM data_pelatihan");
            ...
            <div class="row">
                ...
                <div class="col" id="kol-dashboard">
                    <div class="row" id="header-dashboard">
                        <div class="col">
                            <span> 
                                <h2><i class="fa-solid fa-newspaper"></i>KELOLA DATA PELATIHAN</h2>
                                <hr style="width:900px;">
                            </span>
                        </div>
                    </div>
                    <a class="btn btn-primary me-5" href="dashboard-admin.php" role="button">Kembali</a>
                    <a href="dashboard-admin-tambahquizmorfologi.php" type="button" class="btn btn-outline-success">Quiz Morfologi</a>
                    <a href="dashboard-admin-tambahquizmediabudidaya.php" type="button" class="btn btn-outline-success">Quiz Media Budidaya</a>
                    <a href="dashboard-admin-tambahquizpembesaran.php" type="button" class="btn btn-outline-success">Quiz Pembesaran</a>
                    <a href="dashboard-admin-tambahquizpemijahan.php" type="button" class="btn btn-outline-success">Quiz Pemijahan</a>
                    <a href="soal-ujianakhir.php" type="button" class="btn btn-outline-success">Ujian Akhir</a>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($admin as $row) : ?>
                                <tr>
                                    ...
                                    <td><?=$row["telepon_peserta"];?></td>
                                    <td><?=$row["email_peserta"];?></td>
                                    <td>
                                        <?php
                                            if ($row["nilai_pelatihan"] < 1 ) {
                                                echo "";
                                            }else {
                                                echo $row["nilai_pelatihan"].'%';
                                            }
                                        ?>
                                    </td>
