            ...
            <div class="row">
                ...
                <div class="col" id="kol-dashboard">
                    <div class="row" id="header-dashboard">
                        <div class="col">
                            <span> 
                                <h2><i class="fa-solid fa-house-chimney"></i>DASHBOARD ADMIN</h2>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card" style="width: 18rem;" id="profil-admin">
                                <div class="card-header">
                                    <h5 class="card-title">Profil Admin</h5>
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title"><?=$row["nama_adm"];?></h5>
                                    <p class="card-text">Perbarui Data Anda</p>
                                    <a href="dashboard-admin-profil.php" class="btn btn-primary">Kelola</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="card" style="width: 18rem;" id="pelatihan">
                                <div class="card-header">
                                    <h5 class="card-title">Pelatihan</h5>
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title">Pelatihan Budidaya</h5>
                                    <p class="card-text">Kelola Pelatihan</p>
                                    <a href="dashboard-admin-keloladatapelatihan.php" class="btn btn-primary">Kelola</a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" style="width: 18rem;" id="akun">
                                <div class="card-header">
                                    <h5 class="card-title">Kelola Akun</h5>
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title">Akun User dan Admin</h5>
                                    <p class="card-text">Kelola akun user dan akun admin</p>
                                    <a href="dashboard-admin-akunadmin.php" class="btn btn-primary">Kelola</a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card" style="width: 18rem;"id="konten">
                                <div class="card-header">
                                    <h5 class="card-title">Kelola Konten</h5>
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title">Konten Website</h5>
                                    <p class="card-text">Kelola Konten Website</p>
                                    <a href="dashboard-admin-konten.php" class="btn btn-primary">Kelola</a>
                                </div>
                            </div>
                        </div>
                    </div>
