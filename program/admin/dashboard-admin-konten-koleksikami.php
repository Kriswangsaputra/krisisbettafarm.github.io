<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        mysqli_query($koneksi, "DELETE FROM koleksi_kami WHERE id = $id");
    }
        ...
        <div class="container-sm">
            <div class="row">
                ...
                <div class="col" id="kol-dashboard">
                    ...
                    <a class="btn btn-primary me-5" href="dashboard-admin-konten.php" role="button">Kembali</a>
                    <a class="btn btn-primary" href="dashboard-admin-konten-tambah-koleksikami.php" role="button">Tambah Konten</a>

                    <div class="card mt-5">
                        <h5 class="card-header"> Koleksi Kami</h5>
                            ...
                            <table class="table mb-5">
                                ...
                                <tbody>
                                    <?php foreach ($admin as $row) : ?>
                                        <tr>
                                            <td><?=$row["id"];?></td>
                                            <td><?=$row["judul_kntn_koleksi"];?></td>
                                            <td><img src="../../img/upload/<?=$row["gambar_kntn_koleksi"];?>" alt="" width="50"></td>
                                            <td><?=$row["deskripsi_kntn_koleksi"];?></td>
                                            <td>
