<?php
    ...
    $user = query("SELECT * FROM akun_user WHERE id_user = $id")[0];
    ...
    if (isset($_POST["submit"])) {
        ...
        if (ubahinfo($_POST) > 0 ) {
            echo "<script>
                ...
                document.location.href='dashboard-user-infopribadi.php';
            </script>";
        }else {
            echo "
...
<html lang="en">
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item dropdown ms-3">
                            ...
                            Belajar
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    ...
                                    <li><a class="dropdown-item text-dark" href="sejarah-ikan-cupang">Sejarah Ikan Cupang</a></li>
                                </ul>
                        </li>
                        <li class="nav-item ms-3">
                        ...
                        <li class="nav-item ms-3">
                            <a class="nav-link text-light" href="pendaftaran-pelatihan">Pelatihan</a>
                        </li>
                        <li class="nav-item ms-3">
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="card shadow" id="isi-submenu">
                    <div class="card-header">
                        <h5 class="card-title" id="judul"><i class="fa-solid fa-circle-user"></i> Informasi Pribadi</a></h5>
                    </div>
                    <div class="card-body">
                        <form action="" method="post">

                        <input type="hidden" name="id" class="form-info" value="<?= $user["id_user"]; ?>">
                    
                            <div class="kotak-isian">
                                <input type="text" name="nama" class="form-info" value="<?=$user["nama_user"]; ?>">
                                <label for="" class="label-form-info">Nama</label>
                            </div>
                            <div class="kotak-isian">
                                <input type="text" name="tempat_lahir" class="form-info" value ="<?=$user["tempat_lahir_user"]; ?>">
                                <label for="" class="label-form-info">Tempat Lahir</label>
                            </div>
                            <div class="kotak-isian">
                                <input type="date" name="tanggal_lahir" class="form-info" value="<?=$user["tgl_lahir_user"]; ?>">
                                <label for="" class="label-form-info">Tanggal Lahir</label>
                            </div>
                            <div class="kotak-isian">
                                <input type="text" name="nmpengguna" class="form-info" value="<?=$user["nmpengguna_user"]; ?>">
                                <label for="" class="label-form-info">Nama Pengguna</label>
                            </div>
                            <div class="d-grid gap-2">
                                <button class="btn btn-outline-primary" type="submit" name="submit">Simpan</button>
                                <a href="dashboard-user-infopribadi.php" type="button" class="btn btn-outline-success">Kembali</a>
                            </div>
                        </form>
