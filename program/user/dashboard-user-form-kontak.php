    ...
    if (isset($_POST["submit"])) {
        ...
        if (ubahkontak($_POST) > 0 ) {
            echo "<script>
                ...
                document.location.href='dashboard-user-kontak.php';
            </script>";
        }else {
            echo "
...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="kotak-isian">
                                <input type="text" name="alamat" class="form-info" value="<?=$row["alamat_user"];?>">
                                <label for="" class="label-form-info">Alamat</label>
                            </div>
                            <div class="kotak-isian">
                                <input type="Email" name="email" class="form-info" value="<?=$row["email_user"];?>">
                                <label for="" class="label-form-info">Email</label>
                            </div>
                            <div class="kotak-isian">
                                <input type="number" name="telepon" class="form-info" value="<?=$row["telepone_user"];?>">
                                <label for="" class="label-form-info">Telepon</label>
                            </div>
                            <div class="d-grid gap-2">
                                <button name="submit" class="btn btn-outline-primary" type="submit">Ubah kontak Pribadi</button>
                                <a href="dashboard-user-kontak.php" type="button" class="btn btn-outline-success">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <!-- footer -->
        <div class="row bg-black" style="width:100%; padding-left:200px;" id="footer" id="footer">
