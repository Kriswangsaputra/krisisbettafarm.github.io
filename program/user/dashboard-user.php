...
<html lang="en">
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="card shadow" id="isi-submenu" style="height: 23rem">
                    ...
                    <div class="card-body">
                        <h5 class="isi">
                        <ul>
                            <li><a href="dashboard-user-infopribadi.php"><i class="fa-solid fa-circle-user"></i> Informasi Pribadi</a></li>
                            <li><a href="dashboard-user-kontak.php"><i class="fa-solid fa-id-card"></i> Kontak Pribadi</a></li>
                            <li><a href="dashboard-user-sosialmedia.php"><i class="fa-solid fa-users"></i> Sosial Media</a></li>
                        </ul>
                        </h5>
                    </div>
                </div>
