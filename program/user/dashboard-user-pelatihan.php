<?php
    ...
    $admin = query("SELECT * FROM data_pelatihan WHERE email_peserta='$email' ORDER BY id_pelatihan DESC");
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="card shadow" id="isi-submenu">
                        ...
                        <div class="card-body">
                        <?php if (isset($_COOKIE["pelatihan"])) { ?>
                            <table class="table mb-5">
                                <thead>
                                    <tr>
                                        <h3><th scope="col"><?=$_COOKIE["judul"];?></th></h3>
                                        <?php
                                            if ($_COOKIE["judul"] == "Pelatihan Budidaya Ikan Cupang") { ?>
                                                <td>
                                                    <a class="btn btn-primary" href="pelatihan-budidaya.php" role="button">Lanjutkan Pelatihan</a>
                                                </td>
                                        <?php } else { ?>
                                                <td>
                                                    <a class="btn btn-primary" href="pelatihan-kultur-kutuair.php" role="button">Lanjutkan Pelatihan</a>
                                                </td>
                                        <?php } ?>
                                    </tr>
                                </thead>
                                    ...
                                    <table class="table mb-5">
                                        <tr>
                                            ...
                                            <?php foreach( $admin as $data) : ?>
                                                <tr>
                                                    <td><?=$i;?></td>
                                                    <td><?=$data["peserta_pelatihan"];?></td>
                                                    <td><?=$data["pelatihan"];?></td>
                                                    <td>
                                                        <?php
                                                            if ($data["nilai_pelatihan"] < 1 ) {
                                                                echo "";
                                                            }else {
                                                                echo $data["nilai_pelatihan"].'%';
                                                            }
                                                        ?>
                                                    </td>
                                                    <td <?php if ($data["status_pelatihan"] == "tidak lulus") { ?>
                                                        style="background-color:#dc3545; font-weight:bold;"
                                                        <?php } else { ?>
                                                            style="background-color:#198754; font-weight:bold;"
                                                        <?php } ?>>
