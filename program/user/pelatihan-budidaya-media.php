            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="card shadow" style="width: 50rem; margin-right:-100px; padding: 20px;">
                        <div class="card-body">
                            <strong>
                                <h3>Persiapan dan Perlengkapan media Budidaya</h3>
                            </strong>
                            <br>
                            <p style="text-align:justify;">
                            Dalam melakukan budidaya ikan cupang kita harus menyiapkan beberapa perlengkapan dan persiapan khusus. perlengkapan ini adalah pendukun suksesnya pemijahan ikan cupang yang akan kita pelajari di materi selanjutnya.
                            </p>
                            <p style="text-align:justify;">
                            perlengkapan dan persiapan ini terbagi menjadi dua bagian penting, yaitu media pemijahan dan media pembesaran ikan cupang. dalam hal ini perlu diperhatikan kapasitas media harus disesuaikan dengan kapasitas tempat kita melakukan budidaya.
                            </p>
                            <p style="text-align:justify;">
                            Adapun media pemijahannya adalah sebagai berikut :
                                <ol>
                                    <li>
                                        <strong>Air</strong> <br>
                                        air ini lebih baik diendapkan selama minimal satu malam sehingga partikel partikel yang tidak perlu diendapkan dibawah air dan tingkat ph air sesuai dengan kebutuhan.
                                    </li>
                                    <li>
                                        <strong>Garam Ikan</strong> <br>
                                        Garam ikan sangat penting karena garam ini dapat menghambat pertumbuhan penyakit ikan, sehingga kesehatan ikan selama pemijahan terjamin.
                                    </li>
                                    <li>
                                        <strong>Obat Biru</strong> <br>
                                        Obat ini berfungsi sebagai obat tambahan agar ikan tidak mudah stres
                                    </li>
                                    <li>
                                        <strong>Daun Ketapang Kering</strong> <br>
                                        daun ketapang kering juga dapat berfungsi sebagai penyeimbang ph air dan juga sebagai antibiotik alami.
                                    </li>
                                    <li>
                                        <strong>Wadah Pemijahan</strong> <br>
                                        wadah ini adalah bagian paling penting, dimana nantinya pemijahan ikan cupang dilakukan di wadah ini. wadah ini bisa dari baskom ataupun sterofoam kecil. usahakan wadah ini berukuran kecil saja.
                                    </li>
                                    <li>
                                        <strong>Gelas Plastik atau Gelas Bening</strong> <br>
                                        Gelas ini digunakan sebagai tempat menaruh indukan betina sementara ketika proses penjodohan, dimana pejantan harus berfokus membuat gelembung tempat meletakan telur nantinya.
                                </ol>
                            </p>
                            <p style="text-align:justify;">
                            Selanjutnya adalah media pembesaran ikan cupang yang nantinya juga berhubungan dengan materi pembesaran ikan cupang. adapun media pembesarannya adalah sebagai berikut.
                                <ol>
                                    <li>
                                        <strong>Media Pembesaran Burayak Cupang</strong> <br>
                                        Burayak adalah anakan ikan cupang yang masih sangat kecil. untuk media pembesaran ini dapat menggunakan sterofoam ukuran 1,5 meter x 0,5 meter x 0,5 meter. atau menggunakan ember bak mandi, dan bisa juga menggunakan kolam terpal. tentunya media ini menyesuaikan tempat kalian.
                                    </li>
                                    <li>
                                        <strong>Media Pembesaran Ikan Cupang Dewasa</strong> <br>
                                        ikan cupang yang sudah mulai dewasa harus dipisahkan karena sifat cupang yang soliter. media ini dapat menyesuaikan ikan cupang jenis apa dan tempat budidaya kita. jika ikan cupang yang kita budidaya berjenis halfmoon atau giant lebih baik menggunakan ember ukuran sedang atau drigen. jika ikan cupang kita berjenis plakat kita cukup menggunakan botol berukuran 1,5 liter.
                                    </li>
                                    <li>
                                        <strong>Media Ikan Cupang Siap Jual</strong> <br>
                                        Ikan cupang yang siap jual harus kita taruh ditempat rak display agar kita dapat lebih mudah menikmati keindahan ikan tersebut. adapun medianya dapat berupa aquarium soliter berukuran sedang, ataupun toples.
                                    </li>
                                    <li>
                                        <strong>Sekat Soliter</strong> <br>
                                        Dan jangan lupa kita memerlukan skat untuk menutupi soliter agar ikan cupang tidak saling melihat. sekat sangat penting karena ikan cupang akan agresif jika melihat cupang lainnya.
                                    </li>
                                </ol>
                            </p>
                            <br>
                            <div class="container">
                                <div class="row">
                                    <div class="col">
                                        <a class="btn btn-success" href="quiz-morfologi.php" role="button" style="width: 10rem;">Kembali</a>
                                    </div>
                                    <div class="col">
                                        <a class="btn btn-primary" href="quiz-mediabudidaya.php" role="button" style="width: 10rem;">Lanjut</a>
                                    </div>
                                </div>
                            </div>
