                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <?php }else {
                                    if ($row["foto_user"] === "")  { ?>
                                        <li class="nav-item ms-3">
                                            <a class="btn btn-primary" href="dashboard-user.php" role="button">profil User</a>
                                        </li>
                                        <li class="nav-item ms-3">
                ...
                <div class="card shadow" id="isi-submenu">
                    ...
                    <div class="card-body">
                        <div class="kotak-isian">
                            ...
                            <input type="text" name="" class="" disabled placeholder="<?=$row['nama_user'];?>" style="display:block; border:none; background:none;">
                        </div>
                        <div class="kotak-isian">
                            <label for="">Tempat Lahir</label>
                            <input type="text" name="" disabled placeholder="<?=$row['tempat_lahir_user'];?>" style="display:block; border:none; background:none;">
                        </div>
                        <div class="kotak-isian">
                            <label for="">Tanggal Lahir</label>
                            <input type="text" name="" disabled placeholder="<?=$row['tgl_lahir_user'];?>" style="display:block; border:none; background:none;">
                        </div>
                        <div class="kotak-isian">
                            <label for="">Nama Pengguna</label>
                            <input type="text" name="" disabled placeholder="<?=$row['nmpengguna_user'];?>" style="display:block; border:none; background:none;">
                        </div>
                        <div class="d-grid gap-2">
                            <a href="dashboard-user-form-infopribadi.php?id=<?=$row["id_user"];?>" class="btn btn-outline-primary" type="button">Ubah Informasi Pribadi</a>
                            <a href="dashboard-user.php" type="button" class="btn btn-outline-success">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
