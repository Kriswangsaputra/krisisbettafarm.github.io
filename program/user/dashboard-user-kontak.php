                        ...
                        <li class="nav-item dropdown ms-3">
                            ...
                            Belajar
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    ...
                                    <li><a class="dropdown-item text-dark" href="sejarah-ikan-cupang.php">Something else here</a></li>
                                </ul>
                        </li>
                        <li class="nav-item ms-3">
                ...
                <div class="card shadow" id="isi-submenu">
                    ...
                    <div class="card-body">
                        <div class="kotak-isian">
                            ...
                            <input type="text" name="" disabled value="<?=$row["alamat_user"];?>" style="display:block; border:none; background:none;">
                        </div>
                        <div class="kotak-isian">
                            <label for="">Email</label>
                            <input type="Email" name="" disabled value="<?=$row["email_user"];?>" style="display:block; border:none; background:none;">
                        </div>
                        <div class="kotak-isian">
                            <label for="">Telepon</label>
                            <input type="number" name="" disabled value="<?=$row["telepone_user"];?>" style="display:block; border:none; background:none;">
                        </div>
                        <div class="d-grid gap-2">
                            <a href="dashboard-user-form-kontak.php" class="btn btn-outline-primary" type="button">Ubah kontak Pribadi</a>
