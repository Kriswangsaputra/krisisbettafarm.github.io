    ...
    if (isset($_POST["submit"])) {
        ...
        if (ubahpassword($_POST) > 0 ) {
            ...
            echo "
                ...
                document.location.href='dashboard-user-ubah-sandi.php';
                </script>
            ";
        }
    }
                        ...
                        <li class="nav-item dropdown ms-3">
                            ...
                            Belajar
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <li><a class="dropdown-item text-dark" href="jenis-ikan-cupang.php">Another action</a></li>
            ...
            <div class="col">
                <div class="card shadow" id="isi-submenu">
                    <div class="card-header">
                        <h5 class="card-title" id="judul"><i class="fa-solid fa-circle-user"></i> Ubah Kata Sandi</a></h5>
                    </div>
                    <div class="card-body">
                        <form action="" method="post">
                            <input type="hidden" name="id" value="<?=$row["id_user"];?>">
                            <div class="kotak-isian">
                                <input type="password" name="password1" class="form-info">
                                <label for="" class="label-form-info">Kata Sandi Lama</label>
                            </div>
                            <div class="kotak-isian">
                                <input type="password" name="password2" class="form-info">
                                <label for="" class="label-form-info">Kata Sandi Baru</label>
                            </div>
                            <div class="d-grid gap-2">
                                <button name="submit" class="btn btn-outline-primary" type="submit">Ubah Kata Sandi</button>
