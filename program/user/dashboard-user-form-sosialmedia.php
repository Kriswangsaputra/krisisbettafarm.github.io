<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        if (ubahsosmed($_POST) > 0 ) {
            echo "<script>
                alert('Data Berhasil Di Ubah!');
                document.location.href='dashboard-user-sosialmedia.php';
            </script>";
        }else {
            echo "
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="kotak-isian">
                                <input type="text" name="facebook" class="form-info" value="<?=$row["facebook_user"];?>">
                                <label for="" class="label-form-info">Facebook</label>
                            </div>
                            <div class="kotak-isian">
                                <input type="text" name="instagram" class="form-info" value="<?=$row["instagram_user"];?>">
                                <label for="" class="label-form-info">Instagram</label>
                            </div>
                            <div class="kotak-isian">
                                <input type="text" name="twitter" class="form-info" value="<?=$row["twetter_user"];?>">
                                <label for="" class="label-form-info">Twitter</label>
                            </div>
                            <div class="d-grid gap-2">
                                <button name="submit" class="btn btn-outline-primary" type="submit">Ubah Sosial Media</button>
                                <a href="dashboard-user-sosialmedia.php" type="button" class="btn btn-outline-success">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
